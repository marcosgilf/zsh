...
flush-translations(){
  ...
  curl -X 'DELETE' \
  'https://dev.services.example.invalid/translations/cache' \
  -H 'accept: */*'
  echo "[DEV] Flushing $api ingka translations cache..."
  curl -X 'DELETE' \
  https://dev.ecom.example.invalid/${api}/api/v1/translations \
  -H 'accept: application/json'
  echo "[DEV] Flushing $api translations cache..."
  curl -X 'DELETE' \
  https://example.invalid/${api}/api/v1/translations \
  -H 'accept: application/json'
}
...
flush-translations-prod(){
  ...
  curl -X 'DELETE' \
  'https://services.example.invalid/translations/cache' \
  -H 'accept: */*'
  echo "[PROD] Flushing $api ingka translations cache..."
  curl -X 'DELETE' \
  https://ecom.example.invalid/${api}/api/v1/translations \
  -H 'accept: application/json'
